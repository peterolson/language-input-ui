...
const translations: Record<LanguageCode, Record<string, string>> = {
	...
	mk: {
		...
		'progress.saveProgressWarning': `Не сте најавени. Вашиот прогрес ќе биде избришан ако не сте најавени. <br /><a href="/account/create">Креирајте сметка</a> и сачувајте го вашиот прогрес.`,
