...
const translations: Record<LanguageCode, Record<string, string>> = {
	en: {
		...
		'user.email': 'Email',
		'user.emailHint': 'Optional, only needed for password recovery.',
		'user.sendResetLink': 'Send reset link',
		'user.noAccountFound': 'No account found with that email or username.',
		'user.resetPassword': 'Reset link sent. Check your email.',
		'user.changePassword': 'Change password',
		'user.changePasswordError': 'Error changing password.',
		'user.changePasswordSuccess': 'Password reset successfully.',
	...
	es: {
		...
		'user.emailHint': 'Opcional, solo se necesita para recuperar la contraseña.',
		'user.sendResetLink': 'Enviar enlace de restablecimiento',
		'user.noAccountFound':
			'No se encontró ninguna cuenta con ese correo electrónico o nombre de usuario.',
		'user.resetPassword': 'Enlace de restablecimiento enviado. Consultar su correo electrónico.',
		'user.changePassword': 'Cambiar contraseña',
		'user.changePasswordError': 'Error al cambiar la contraseña.',
		'user.changePasswordSuccess': 'Contraseña restablecida con éxito.',
	...
	zh: {
		...
		'user.email': '电子邮件',
		'user.emailHint': '可选，仅用于密码恢复。',
		'user.sendResetLink': '发送重置链接',
		'user.noAccountFound': '没有找到具有该电子邮件或用户名的帐户。',
		'user.resetPassword': '重置链接已发送。 查看你的邮件。',
		'user.changePassword': '修改密码',
		'user.changePasswordError': '更改密码时出错。',
		'user.changePasswordSuccess': '密码重置成功。',
		'sort.recommended': '推荐',
		'sort.newest': '最新',
		'sort.popular': '最流行',
	...
	ca: {
		...
		'user.emailHint': 'Opcional, només necessari per a la recuperació de la contrasenya.',
		'user.sendResetLink': "Envia l'enllaç de restabliment",
		'user.noAccountFound': "No s'ha trobat cap compte amb aquest correu electrònic o nom d'usuari.",
		'user.resetPassword': "S'ha enviat l'enllaç de restabliment. Comprova el teu correu.",
		'user.changePassword': 'Canvia la contrasenya',
		'user.changePasswordError': "S'ha produït un error en canviar la contrasenya.",
		'user.changePasswordSuccess': 'La contrasenya es restableix correctament.',
		'sort.recommended': 'Recomanat',
	...
	fr: {
		...
		'user.email': 'Email',
		'user.emailHint': 'Facultatif, uniquement nécessaire pour la récupération du mot de passe.',
		'user.sendResetLink': 'Envoyer le lien de réinitialisation',
		'user.noAccountFound': "Aucun compte trouvé avec cet e-mail ou ce nom d'utilisateur.",
		'user.resetPassword': 'Réinitialiser le lien envoyé. Vérifiez votre courrier électronique.',
		'user.changePassword': 'Modifier le mot de passe',
		'user.changePasswordError': 'Erreur lors de la modification du mot de passe.',
		'user.changePasswordSuccess': 'Réinitialisation du mot de passe réussie.',
	...
	de: {
		...
		'user.email': 'E-Mail',
		'user.emailHint': 'Optional, wird nur für die Passwortwiederherstellung benötigt.',
		'user.sendResetLink': 'Reset-Link senden',
		'user.noAccountFound': 'Kein Konto mit dieser E-Mail oder diesem Benutzernamen gefunden.',
		'user.resetPassword': 'Reset-Link gesendet. Überprüfen Sie Ihren Posteingang.',
		'user.changePassword': 'Passwort ändern',
		'user.changePasswordError': 'Fehler beim Ändern des Passworts.',
		'user.changePasswordSuccess': 'Passwort erfolgreich zurückgesetzt.',
	...
	el: {
		...
		'user.email': 'Email',
		'user.emailHint': 'Προαιρετικό, απαιτείται μόνο για ανάκτηση κωδικού πρόσβασης.',
		'user.sendResetLink': 'Αποστολή συνδέσμου επαναφοράς',
		'user.noAccountFound': 'Δεν βρέθηκε λογαριασμός με αυτό το email ή όνομα χρήστη.',
		'user.resetPassword': 'Εστάλη σύνδεσμος επαναφοράς. Ελέγξτε το email σας.',
		'user.changePassword': 'Αλλαγή κωδικού πρόσβασης',
		'user.changePasswordError': 'Σφάλμα αλλαγής κωδικού πρόσβασης.',
		'user.changePasswordSuccess': 'Επαναφορά κωδικού πρόσβασης επιτυχώς.',
	...
	it: {
		...
		'utente.e-mail': 'E-mail',
		'user.emailHint': 'Facoltativo, necessario solo per il recupero della password.',
		'user.sendResetLink': 'Invia link di ripristino',
		'user.noAccountFound': "Nessun account trovato con quell'e-mail o nome utente.",
		'user.resetPassword': 'Reimposta collegamento inviato. Controlla la tua email.',
		'user.changePassword': 'Cambia password',
		'user.changePasswordError': 'Errore durante la modifica della password.',
		'user.changePasswordSuccess': 'Reimposta password riuscita.',
		'sort.recommended': 'Raccomandato',
	...
	ja: {
		...
		'user.email': 'Eメール',
		'user.emailHint': 'オプション、パスワードの回復にのみ必要です。',
		'user.sendResetLink': 'リセットリンクを送信',
		'user.noAccountFound': 'そのメールアドレスまたはユーザー名のアカウントが見つかりません。',
		'user.resetPassword': 'リセットリンクが送信されました。 あなたのメールをチェック。',
		'user.changePassword': 'パスワードの変更',
		'user.changePasswordError': 'パスワードの変更中にエラーが発生しました。',
		'user.changePasswordSuccess': 'パスワードが正常にリセットされました。',
	...
	lt: {
		...
		'user.emailHint': 'Pasirenkama, reikalinga tik slaptažodžiui atkurti.',
		'user.sendResetLink': 'Siųsti atstatymo nuorodą',
		'user.noAccountFound': 'Nerasta jokios paskyros su tuo el. pašto adresu arba naudotojo vardu.',
		'user.resetPassword': 'Atkūrimo nuoroda išsiųsta. Patikrink savo paštą.',
		'user.changePassword': 'Keisti slaptažodį',
		'user.changePasswordError': 'Klaida keičiant slaptažodį.',
		'user.changePasswordSuccess': 'Slaptažodis sėkmingai nustatytas iš naujo.',
		'sort.recommended': 'Rekomenduojami',
	...
	nb: {
		...
		'user.email': 'E-post',
		'user.emailHint': 'Valgfritt, kun nødvendig for passordgjenoppretting.',
		'user.sendResetLink': 'Send tilbakestillingslink',
		'user.noAccountFound': 'Ingen konto funnet med den e-postadressen eller brukernavnet.',
		'user.resetPassword': 'Tilbakestill lenke sendt. Sjekk e-posten.',
		'user.changePassword': 'Endre passord',
		'user.changePasswordError': 'Feil ved endring av passord.',
		'user.changePasswordSuccess': 'Passord tilbakestilt vellykket.',
		'sort.recommended': 'Anbefalt',
		'sort.newest': 'Nyeste',
	...
	pl: {
		...
		'user.email': 'E-mail',
		'user.emailHint': 'Opcjonalnie, potrzebne tylko do odzyskiwania hasła.',
		'user.sendResetLink': 'Wyślij link resetowania',
		'user.noAccountFound': 'Nie znaleziono konta z tym adresem e-mail lub nazwą użytkownika.',
		'user.resetPassword': 'Wysłano łącze resetowania. Sprawdź swój email.',
		'user.changePassword': 'Zmień hasło',
		'user.changePasswordError': 'Błąd podczas zmiany hasła.',
		'user.changePasswordSuccess': 'Hasło zostało zresetowane pomyślnie',
	...
	pt: {
		...
		'user.email': 'Email',
		'user.emailHint': 'Opcional, necessário apenas para recuperação de senha.',
		'user.sendResetLink': 'Enviar link de redefinição',
		'user.noAccountFound': 'Nenhuma conta encontrada com esse e-mail ou nome de usuário.',
		'user.resetPassword': 'Redefinir link enviado. Verifique seu e-mail.',
		'user.changePassword': 'Alterar senha',
		'user.changePasswordError': 'Erro ao alterar a senha.',
		'user.changePasswordSuccess': 'Senha redefinida com sucesso.',
		'sort.recommended': 'Recomendado',
	...
	ro: {
		...
		'user.email': 'E-mail',
		'user.emailHint': 'Opțional, necesar doar pentru recuperarea parolei.',
		'user.sendResetLink': 'Trimite linkul de resetare',
		'user.noAccountFound': 'Nu s-a găsit niciun cont cu acel e-mail sau nume de utilizator.',
		'user.resetPassword': 'Resetare link-ul a fost trimis. Verifica-ti email-ul.',
		'user.changePassword': 'Schimbați parola',
		'user.changePasswordError': 'Eroare la schimbarea parolei.',
		'user.changePasswordSuccess': 'Resetarea parolei cu succes.',
		'sort.recommended': 'Recomandat',
	...
	ru: {
		...
		'user.emailHint': 'Необязательно, требуется только для восстановления пароля.',
		'user.sendResetLink': 'Отправить ссылку для сброса',
		'user.noAccountFound':
			'Аккаунт с таким адресом электронной почты или именем пользователя не найден.',
		'user.resetPassword': 'Ссылка для сброса отправлена. Проверьте свою электронную почту. ',
		'user.changePassword': 'Сменить пароль',
		'user.changePasswordError': 'Ошибка при изменении пароля.',
		'user.changePasswordSuccess': 'Пароль успешно сброшен.',
	...
	da: {
		...
		'user.email': 'E-mail',
		'user.emailHint': 'Valgfrit, kun nødvendigt for gendannelse af adgangskode.',
		'user.sendResetLink': 'Send nulstillingslink',
		'user.noAccountFound': 'Ingen konto fundet med den e-mail eller brugernavn.',
		'user.resetPassword': 'Nulstil link sendt. Tjek din e-mail.',
		'user.changePassword': 'Wachtwoord wijzigen',
		'user.changePasswordError': 'Fout bij wijzigen wachtwoord.',
		'user.changePasswordSuccess': 'Wachtwoord opnieuw ingesteld.',
		'sort.recommended': 'Anbefalet',
		'sort.newest': 'Nyeste',
	...
	nl: {
		...
		'user.email': 'E-mail',
		'user.emailHint': 'Optioneel, alleen nodig voor wachtwoordherstel.',
		'user.sendResetLink': 'Verstuur reset-link',
		'user.noAccountFound': 'Geen account gevonden met dat e-mailadres of die gebruikersnaam.',
		'user.resetPassword': 'Resetlink verzonden. Controleer je e-mail.',
		'user.changePassword': 'Wachtwoord wijzigen',
		'user.changePasswordError': 'Fout bij wijzigen wachtwoord.',
		'user.changePasswordSuccess': 'Wachtwoord opnieuw ingesteld.',
